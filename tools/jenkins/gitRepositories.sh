...
GIT_URL_OPENFX_MISC_GITHUB=${GIT_URL_OPENFX_MISC_GITHUB:-https://github.com/ma12vlad/openfx-misc.git}
...
KNOWN_NATRON_REPOSITORIES="$GIT_URL_NATRON_GITHUB $GIT_URL_NATRON_GFORGE"
